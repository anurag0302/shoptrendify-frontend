    ...
    return (
        <div className='p-5'>
            {/* <Carousel autoplay className='p-2'>
                <div className='flex h-52 md:h-[60vh] w-full '>
                ...
                <div className='flex bg-slate-400 h-52 md:h-[60vh] w-full '>
                ...
                <div className='flex bg-red-300 h-52 md:h-[60vh] w-full '>
                ...
                <div className='flex bg-blue-300 h-52 md:h-[60vh] w-full '>
